...
- [hectorTSH/dgx-spark-memory-dashboard](https://github.com/hectorTSH/dgx-spark-memory-dashboard) - Live GiB-accurate unified-memory occupancy map for DGX Spark: Dense/MoE blocks, Ollama/vLLM/HF inventory, multi-Spark tabs, and a “can I load next?” fit advisor.
